...
export const DEFAULT_CONFIG: SiteConfig = {
    siteName: 'Chronicles',
    siteTagline: 'Future Gadget Lab',
    partnerA: {
        nickname: 'Kurisu',
        displayName: 'Makise Kurisu',
        roleLabel: 'Christina',
        defaultTitle: 'The Zombie',
        defaultBio: 'Neuroscientist, tsundere, dan satu-satunya yang bisa menghentikan Hououin Kyouma.',
        pageSlug: 'her',
        colorTheme: 'pink',
    },
    partnerB: {
        nickname: 'Okabe',
        displayName: 'Okabe Rintaro',
        roleLabel: 'Mad Scientist',
        defaultTitle: 'Hououin Kyouma',
        defaultBio: 'Penemu Time Leap Machine. Melintas ribuan worldline hanya untuk satu orang.',
        pageSlug: 'him',
        colorTheme: 'blue',
    },
    zeroMarker: {
        name: 'SERN Agent',
        description: '0% - Divergence awal sebelum bertemu Christina',
    },
    letter: {
        defaultGreeting: 'Hai, Christina...',
        defaultClosing: 'El Psy Kongroo. — Hououin Kyouma',
    },
    startDate: '',
